...
namespace WebApplication3.Data.Repositories
{
    public class TokenRepository : ITokenRepository
    {
        ...
        public string createJWT(IdentityUser user, List<string> roles)
        {
            ...
            var token = new JwtSecurityToken(configuration["Jwt:Issuer"], configuration["Jwt:Audience"], claims, expires: DateTime.Now.AddMinutes(15), signingCredentials: creadentials);
